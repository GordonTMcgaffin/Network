...
public class ClientGUI
        ...
        throws Exception
    {
        ...
        int port = -1;
        try {
            host = super.getParameters().getRaw().get(0);
            port = Integer.parseInt(super.getParameters().getRaw().get(1));
        } catch (IndexOutOfBoundsException ioobe) {
            System.err.println("Two arguments must be provided: the hostname " +
                               "and port number.");
            System.exit(1);
        }
        ...
        JLabel l = new JLabel("Connecting to server...", SwingConstants.CENTER);
